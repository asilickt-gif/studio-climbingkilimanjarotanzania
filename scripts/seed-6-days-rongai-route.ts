/**
 * One-off: create/update ONLY the new "6 Days Rongai Route" trip document
 * from content/packages.ts. Mirrors seed-9-days-lemosho-route.ts — does not
 * touch any other trip document.
 *
 * Idempotent: upserts by slug.
 *
 * Run from the studio folder:
 *   npx sanity exec scripts/seed-6-days-rongai-route.ts --with-user-token
 */
